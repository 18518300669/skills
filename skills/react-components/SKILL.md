...
description: Convert Google Stitch designs into modular Vite and React components using Stitch MCP retrieval, fetch-stitch networking, typed props, mock data layers, and AST validation. Use when the user wants Stitch screens turned into React code, component libraries from Stitch, or validated modular frontend output from Stitch HTML/CSS. Requires Stitch MCP access. For DESIGN.md authoring without component codegen, use design-md.
allowed-tools:
  - "stitch*:*"
  - "Bash"
  - "Read"
...
Vendored from [skills.sh leaderboard #376](https://skills.sh/google-labs-code/stitch-skills/react:components). Source aligned with [google-labs-code/stitch-skills react:components](https://github.com/google-labs-code/stitch-skills/tree/main/plugins/stitch-build/skills/react-components) (Apache-2.0; see `skills/react-components/LICENSE.txt`).
