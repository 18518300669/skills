...
**WARNING - AI SLOP TRAP**: Read **`skills/impeccable/SKILL.md`** and its anti-pattern guidance before proceeding. Bold means distinctive, not "more effects."
...
- **Replace generic fonts**: Swap system fonts for distinctive choices (see the parent skill's typography guidelines and `skills/impeccable/reference/typography.md` for inspiration)
...
When the result feels right, hand off to `skills/polish/SKILL.md` (procedure in `skills/polish/reference/polish.md`) for the final pass.
