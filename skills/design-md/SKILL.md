---
name: design-md
description: When the user wants to analyze a Google Stitch design project and generate or update a semantic DESIGN.md design-system file for Stitch screen generation. Also use when the user mentions "Stitch design system," "DESIGN.md for Stitch," "Stitch project design tokens," "Stitch MCP design analysis," "semantic design system from Stitch screens," or needs a prompting source of truth from existing Stitch HTML/CSS. Requires Stitch MCP access and at least one designed screen. For anti-slop DESIGN.md authoring without Stitch MCP, see stitch-design-taste. For extracting design systems from local frontend code, see extract-design-system.
allowed-tools:
  - "stitch*:*"
  - "Read"
  - "Write"
...
This skill is the **design-md** workflow from the [skills.sh leaderboard #376](https://skills.sh/google-labs-code/stitch-skills/design-md) (source aligned with [google-labs-code/stitch-skills design-md](https://github.com/google-labs-code/stitch-skills/tree/main/plugins/stitch-utilities/skills/design-md); Apache-2.0; see `skills/design-md/LICENSE.txt`). Example output in `skills/design-md/examples/DESIGN.md`.
