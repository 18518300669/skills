...
Complete **Mandatory preparation** in `skills/quieter/SKILL.md` before changing color, contrast, or motion. You need design-law context from `skills/impeccable/SKILL.md` (and usually `skills/frontend-design/SKILL.md` / `skills/web-design-guidelines/SKILL.md`), plus clarity on **purpose, audience, and what is already working**.
