...
This skill is the **free-tool-strategy** workflow from the [skills.sh leaderboard #360](https://skills.sh/coreyhaines31/marketingskills/free-tool-strategy) (procedural content aligned with [coreyhaines31/marketingskills `free-tools`](https://github.com/coreyhaines31/marketingskills/tree/main/skills/free-tools); upstream v2 folder name is `free-tools`, but the skills.sh catalog retains this entry as `free-tool-strategy`).
...
- **`skills/lead-magnets/SKILL.md`**: For downloadable content lead magnets (ebooks, checklists, templates)
- **`skills/page-cro/SKILL.md`**: For optimizing the tool's landing page
- **`skills/seo-audit/SKILL.md`**: For SEO-optimizing the tool
- **`skills/analytics-tracking/SKILL.md`**: For measuring tool usage
- **`skills/email-sequence/SKILL.md`**: For nurturing leads from the tool
