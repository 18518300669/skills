...
- Step 4 in the workflow escalation pattern (`skills/firecrawl/SKILL.md`): search → scrape → map → **crawl** → interact
...
- [firecrawl-agent](../firecrawl-agent/SKILL.md) — structured JSON extraction for complex multi-page sites
