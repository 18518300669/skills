...
If any of these are unclear from the codebase, ask the user directly before inventing tone, humor, or brand personality.
...
When the moments feel earned, hand off to **`skills/polish/SKILL.md`** for the final pass.
