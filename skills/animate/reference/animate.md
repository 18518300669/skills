...
If any of these are unclear from the codebase, stop and ask the user concise questions for the missing items above before you continue.
...
When the motion clarifies state instead of decorating it, hand off to project-local polish (`skills/polish/SKILL.md`) for the final pass.
