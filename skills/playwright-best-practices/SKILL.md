...
This skill is vendored from the [skills.sh leaderboard #370](https://skills.sh/currents-dev/playwright-best-practices-skill/playwright-best-practices). Source: [currents-dev/playwright-best-practices-skill](https://github.com/currents-dev/playwright-best-practices-skill) (MIT; see `skills/playwright-best-practices/LICENSE.txt`). Pair with `skills/playwright-cli/SKILL.md` for CLI-driven browser automation and `skills/webapp-testing/SKILL.md` for Python/Playwright local app testing.
