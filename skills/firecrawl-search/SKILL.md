...
- First step in the workflow escalation pattern (`skills/firecrawl/SKILL.md`): search → scrape → map → crawl → interact
...
- `skills/firecrawl/SKILL.md` — umbrella Firecrawl CLI skill for install/auth, map, crawl, interact, and workflow escalation
- `skills/firecrawl-scrape/SKILL.md` — scrape a specific URL after search discovers it
