...
When the user-facing numbers move, hand off to **polish**: read and follow `skills/polish/SKILL.md` and `skills/polish/reference/polish.md` for the final visual and micro-detail pass.
