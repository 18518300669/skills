...
4. **Pull in any prior critique** (optional signal): If a critique, design review, or audit already exists for the same target (for example a markdown note in-repo, a ticket, or notes from an earlier pass in the conversation), fold its P0/P1 items into your polish list and briefly cite what you used. If nothing exists, continue with your own pass. Prior critique is one input among many.
