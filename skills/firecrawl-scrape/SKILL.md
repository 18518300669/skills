...
- Step 2 in the workflow escalation pattern (`skills/firecrawl/SKILL.md`): search → **scrape** → map → crawl → interact
...
- `skills/firecrawl/SKILL.md` — umbrella Firecrawl CLI skill for `search`, `interact`, `download`, `map`, `crawl`, and install/auth notes under `skills/firecrawl/rules/`
