...
Brand: run the font selection procedure in [`skills/impeccable/reference/brand.md`](../../impeccable/reference/brand.md). Fluid `clamp()` scale, ≥1.25 ratio between steps.
...
The tactical selection procedure and the reflex-reject list live in [`skills/impeccable/reference/brand.md`](../../impeccable/reference/brand.md) under **Font selection procedure** and **Reflex-reject list** (loaded for brand-register tasks). The rest of this section covers the adjacent knowledge: anti-reflex corrections, system font use, and pairing rules.
