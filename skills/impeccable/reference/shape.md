...
This is a required interaction, not optional guidance. Ask these questions in conversation, adapting based on answers. Don't dump them all at once; have a natural dialogue. Ask the user
...
Ask the user Ask for explicit confirmation of the brief before finishing.
