...
Apply the correct template based on type. See [docs/contributing/catalog.mdx](https://github.com/heygen-com/hyperframes/blob/main/docs/contributing/catalog.mdx) for copy-paste starters and quality rules.
