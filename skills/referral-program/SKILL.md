...
This skill is the **referral-program** workflow from the [skills.sh leaderboard #271](https://skills.sh/coreyhaines31/marketingskills/referral-program) (procedural content aligned with [coreyhaines31/marketingskills `referrals`](https://github.com/coreyhaines31/marketingskills/tree/main/skills/referrals); upstream v2 folder name is `referrals`, but the skills.sh catalog retains this entry as `referral-program`).
...
- **`launch-strategy`**: For launching a referral program effectively
